...
#Función que es llamada cuando se hace clic en el botón Comprar
def comprar():
	...
	#precio del libro seleccionado desde diccionario
	precio = precios[libro_selccionado]

	#restar el precio del libro seleccionado al saldo - se supone que debe funcionar pero mee
	global saldo
	if saldo >= precio:
		saldo -= precio
...
#etiquetas y elementos dentro de la ventana utilizando grid
